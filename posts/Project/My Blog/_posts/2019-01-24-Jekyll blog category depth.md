...
* <img src="/resource/img/blogcategorydepth(1).jpg" width="400px" height="600px">
* _posts 폴더에 post 들을 그냥 집어 넣었다.
* <img src="/resource/img/blogcategorydepth(3).PNG" width="400px" height="600px">
* 이전에는 카테고리를 YAML 머릿말에서 관리했다. ( ex: categories: android )

## 변경 이유

* <img src="/resource/img/blogcategorydepth.PNG" width="400px" height="600px">
...
* <img src="/resource/img/blogcategorydepth(2).PNG" width="400px" height="600px">
...
* <img src="resource/img/blogcategorydepth(4).PNG" width="400px" height="600px">
